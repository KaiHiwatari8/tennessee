...
export default function Plans() {
	return (
		<div className="plans pt-5">
			<section className="container lg:px-40 px-4 text-justify">
				...
				<div className="plans lg:mt-4">
					{
						allPlans.map((plan, idx) => (
							<div key={idx} className="flex flex-row justify-between border border-gray-500 shadow-sm shadow-slate-400 rounded-2xl p-4 my-4 mx-auto lg:w-96">
								<span>
