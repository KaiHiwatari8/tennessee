...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 360)), "/Users/jayprajapati/Developer/websites/tennesse/app/(marketing)/plans/[path]/page.tsx"],
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6500)), "/Users/jayprajapati/Developer/websites/tennesse/app/(marketing)/layout.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 5596)), "/Users/jayprajapati/Developer/websites/tennesse/app/layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4756))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/Users/jayprajapati/Developer/websites/tennesse/app/(marketing)/plans/[path]/page.tsx"];
    ...
    const originalPathname = "/(marketing)/plans/[path]/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1651))
...
;// CONCATENATED MODULE: ./components/link-button.tsx
/* __next_internal_client_entry_do_not_use__ LinkButton auto */ 

function LinkButton({ link , displayText , className  }) {
...
var generated = __webpack_require__(5260);
...
var useMDXComponent = __webpack_require__(7382);
// EXTERNAL MODULE: ./node_modules/tailwind-merge/dist/tailwind-merge.cjs.production.min.js
var tailwind_merge_cjs_production_min = __webpack_require__(9640);
// EXTERNAL MODULE: ./node_modules/clsx/dist/clsx.js
var clsx = __webpack_require__(115);
;// CONCATENATED MODULE: ./lib/utils.tsx
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Users/jayprajapati/Developer/websites/tennesse/components/link-button.tsx`)
...
const e0 = proxy["LinkButton"];

;// CONCATENATED MODULE: ./components/mdx-component.tsx
...
const components = {
    header: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime_.jsx("header", {
            className: mergeClass("text-5xl font-extrabold", className),
            ...props
        }),
    h1: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime_.jsx("h1", {
            className: mergeClass("text-6xl", className),
            ...props
        }),
    h2: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime_.jsx("h2", {
            className: mergeClass("text-2xl lg:text-4xl py-3", className),
            ...props
        }),
    a: ({ className , ...props })=>/*#__PURE__*/ jsx_runtime_.jsx("a", {
            className: mergeClass("", className),
            ...props
        }),
    Image: (image_default()),
...
;// CONCATENATED MODULE: ./app/(marketing)/plans/[path]/page.tsx





async function getPlanFromUrl(params) {
    const plan = generated/* allPlans.find */.kx.find((p)=>p.pathSlug === params.path);
    if (!plan) {
        return null;
    }
    return plan;
...
async function generateStaticParams() {
    return generated/* allPlans.map */.kx.map((val, idx)=>({
            path: val.pathSlug,
            index: idx
        }));
}
async function Plan({ params  }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("article", {
        className: "plan_wrapper container lg:px-40 px-3 mx-auto py-5",
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("header", {
                className: "plan_title text-gray-100",
                children: [
            ...
            plan.image && /*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
                src: plan.image,
                width: "1000",
                height: "900",
...
var __webpack_exports__ = __webpack_require__.X(0, [859,379,465,198,903,426,584,260], () => (__webpack_exec__(6574)));
